...
- (void)setupSessionPreset:(NSString *)sessionPreset metadataObjectTypes:(NSArray *)metadataObjectTypes currentController:(UIView *)currentController {
    ...
    _videoPreviewLayer.frame = CGRectMake(x, y, w, h*0.85);
    [currentController.layer addSublayer:_videoPreviewLayer];
